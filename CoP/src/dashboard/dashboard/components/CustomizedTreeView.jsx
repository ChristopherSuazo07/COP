...
const ITEMS = [
  {
    id: "1",
    label: "Analisis de Oferta",
    children: [
      { id: "1.1", label: "Costo Producción", color: "green" },
      { id: "1.2", label: "Margen Tal", color: "green" },
      { id: "1.3", label: "Costo Tal", color: "green" },
      {
        id: "1.4",
        label: "Categories",
        children: [
          { id: "1.4.1", label: "Gadgets", color: "blue" },
          { id: "1.4.2", label: "Phones", color: "blue" },
          { id: "1.4.3", label: "Wearables", color: "blue" },
        ],
      },
      {
        id: "1.5",
  ...
  {
    id: "3",
    label: "Analisis de la Elasticidad",
    children: [
      { id: "3.1", label: "All products", color: "green" },
      {
        id: "3.2",
        label: "Categories",
        children: [
          { id: "3.2.1", label: "Gadgets", color: "blue" },
          { id: "3.2.2", label: "Phones", color: "blue" },
          { id: "3.2.3", label: "Wearables", color: "blue" },
        ],
      },
      { id: "3.3", label: "Bestsellers", color: "green" },
      { id: "3.4", label: "Sales", color: "green" },
    ],
  },
];
